...
class SQuAD(BaseDataset):
    examplars: List[Dict] = [
        {
            ...
            "cot": "This projection was not included in the final summary for policymakers. The IPCC has since acknowledged that the date is incorrect, while reaffirming that the conclusion in the final summary was robust. They expressed regret for \"the poor application of well-established IPCC procedures in this instance.",
            "answer": "The date"
        },
        {
            ...
            "cot": "The San Bernardino-Riverside area maintains the business districts of Downtown San Bernardino, Hospitality Business/Financial Centre, University Town which are in San Bernardino and Downtown Riverside.",
            "answer": "Riverside"
        },
        {
            "question": "What is a growing sport in southern California?",
            "cot": "Rugby is also a growing sport in southern California, particularly at the high school level, with increasing numbers of schools adding rugby as an official school sport.",
            "answer": "Rugby"
        },
        {
            "question": "Where might a teacher teach that is not inside a building?",
            "cot": "In education, teachers facilitate student learning, often in a school or academy or perhaps in another environment such as outdoors. A teacher who teaches on an individual basis may be described as a tutor.",
            "answer": "Outdoors"
        },
        {
            "question": "How much money did John Jacob Astor IV provide Tesla with?",
            "cot": "In 1899, John Jacob Astor IV invested $100,000 for Tesla to further develop and produce a new lighting system. Instead, Tesla used the money to fund his Colorado Springs experiments.",
            "answer": "$100,000"
        },
        {
            "question": "Along with the American Institute of Electrical Engineers what other institute eventually became the IEEE?",
            "cot": "Tesla served as a vice president of the American Institute of Electrical Engineers, the forerunner (along with the Institute of Radio Engineers) of the modern-day IEEE, from 1892 to 1894.",
            "answer": "The Institute of Radio Engineers"
        },
        {
            "question": "What country are all the counties in?",
            "cot": "Its counties of Los Angeles, Orange, San Diego, San Bernardino, and Riverside are the five most populous in the state and all are in the top 15 most populous counties in the United States.",
            "answer": "United States"
        },
        {
            "question": "Who received a bid in 1915?",
            "cot": "In the years after these rumors, neither Tesla nor Edison won the prize (although Edison did receive one of 38 possible bids in 1915 and Tesla did receive one of 38 possible bids in 1937).",
            "answer": "Edison"
        }
    ]
    ...
    def __init__(self, data_path: str):
        logger.info(f"Loading SQuAD-v1.1 dev from {data_path}")
        dataset = []
        with open(os.path.join(data_path, 'dev-v1.1.json'), "r") as fin:
            js = json.load(fin)

            data = js["data"]
            contexts = []
            for d in data:  # 每个title里拿一个作为样例
